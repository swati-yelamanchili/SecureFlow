...
`AST-based Python security scanner with taint tracking, flow-aware findings, severity grouping, and config misconfiguration checks.`

## Suggested Topics

`python`, `security`, `static-analysis`, `sast`, `ast`, `owasp`, `taint-analysis`, `code-scanner`

## GitHub Upload Checklist

- Add a repository name such as `security-scanner` or `python-security-scanner`
- Push `security_scanner.py`, `README.md`, and `.gitignore`
- Do not commit the local `security/` virtual environment
- Add a license if you plan to make the repository public
- Add example vulnerable test files later if you want demo screenshots or CI validation
